/*******************************************************************************
 * Dense gain cache with O(m) memory for all graphs.
 *
...
class DenserGainCache {
  ...
  using Self = DenserGainCache<iterate_nonadjacent_blocks, DeltaGainCache, iterate_exact_gains>;
...
public:
  ...
  DenserGainCache(const Context &ctx, const NodeID preallocate_n, BlockID preallocate_k)
      : _ctx(ctx),
