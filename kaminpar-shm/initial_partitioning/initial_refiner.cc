...
void InitialTwoWayFMRefiner<QueueSelectionPolicy, CutAcceptancePolicy, StoppingPolicy>::init(
...
template <typename QueueSelectionPolicy, typename CutAcceptancePolicy, typename StoppingPolicy>
bool InitialTwoWayFMRefiner<QueueSelectionPolicy, CutAcceptancePolicy, StoppingPolicy>::refine(
...
template <typename QueueSelectionPolicy, typename CutAcceptancePolicy, typename StoppingPolicy>
bool InitialTwoWayFMRefiner<QueueSelectionPolicy, CutAcceptancePolicy, StoppingPolicy>::abort(
...
template <typename QueueSelectionPolicy, typename CutAcceptancePolicy, typename StoppingPolicy>
EdgeWeight InitialTwoWayFMRefiner<QueueSelectionPolicy, CutAcceptancePolicy, StoppingPolicy>::round(
...
template <typename QueueSelectionPolicy, typename CutAcceptancePolicy, typename StoppingPolicy>
void InitialTwoWayFMRefiner<QueueSelectionPolicy, CutAcceptancePolicy, StoppingPolicy>::init_pq(
    const PartitionedCSRGraph &p_graph
) {
...
template <typename QueueSelectionPolicy, typename CutAcceptancePolicy, typename StoppingPolicy>
void InitialTwoWayFMRefiner<QueueSelectionPolicy, CutAcceptancePolicy, StoppingPolicy>::insert_node(
...
template <typename QueueSelectionPolicy, typename CutAcceptancePolicy, typename StoppingPolicy>
EdgeWeight InitialTwoWayFMRefiner<QueueSelectionPolicy, CutAcceptancePolicy, StoppingPolicy>::
...
template <typename QueueSelectionPolicy, typename CutAcceptancePolicy, typename StoppingPolicy>
void InitialTwoWayFMRefiner<QueueSelectionPolicy, CutAcceptancePolicy, StoppingPolicy>::
    init_weighted_degrees() {
...
template <typename QueueSelectionPolicy, typename CutAcceptancePolicy, typename StoppingPolicy>
bool InitialTwoWayFMRefiner<QueueSelectionPolicy, CutAcceptancePolicy, StoppingPolicy>::
    is_boundary_node(const PartitionedCSRGraph &p_graph, const NodeID u) {
...
template <typename QueueSelectionPolicy, typename CutAcceptancePolicy, typename StoppingPolicy>
bool InitialTwoWayFMRefiner<QueueSelectionPolicy, CutAcceptancePolicy, StoppingPolicy>::
    validate_pqs(const PartitionedCSRGraph &p_graph) {
