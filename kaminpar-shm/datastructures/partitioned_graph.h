...
public:
   ...
   *
   * This is useful after a sequence of partition updates that bypass block weight maintenance, e.g.,
   * when calling `set_block<false>()` in parallel for performance reasons.
   */
