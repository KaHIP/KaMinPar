...
public:
  ...
  void set_max_cluster_weight(const NodeWeight max_cluster_weight) final { _max_cluster_weight = max_cluster_weight; }
...
public:
  ...
  [[nodiscard]] NodeWeight max_cluster_weight(const NodeID /* cluster */) { return _max_cluster_weight; }
...
LabelPropagationClusteringAlgorithm::LabelPropagationClusteringAlgorithm(const NodeID max_n,
