...
public:
    MetricsTestFixture()
        : graph(create_graph({0, 4, 5, 6, 7, 8}, {1, 2, 3, 4, 0, 0, 0, 0}, {4, 1, 1, 1, 1}, {3, 3, 3, 3, 3, 3, 3, 3})) {
    }
...
inline Context create_testing_context(const Graph& graph, const BlockID k = 2, const double epsilon = 0.03) {
    Context context;
