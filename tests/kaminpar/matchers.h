...
public:
  ...
  bool MatchAndExplain(const Graph &graph,
...
public:
  HasWeightedEdgeWithWeightedEndpointsMatcher(const NodeWeight u_weight,
...
HasEdgeWithWeightedEndpoints(const NodeWeight u_weight,
                             const NodeWeight v_weight) {
  return MakeMatcher(
...
inline Matcher<const Graph &>
HasWeightedEdgeWithWeightedEndpoints(const NodeWeight u_weight,
                                     const EdgeWeight e_weight,
                                     const NodeWeight v_weight) {
