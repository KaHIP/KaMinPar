...
template <typename Contractor>
class TrianglesGraph : public DistributedTriangles, public Typed<Contractor> {};
template <typename Contractor>
class EmptyGraph : public DistributedGraphWith9NodesAnd0Edges, public Typed<Contractor> {};
template <typename Contractor>
class NullGraph : public DistributedNullGraph, public Typed<Contractor> {};
template <typename Contractor>
class PathGraph : public DistributedPathTwoNodesPerPE, public Typed<Contractor> {};

using Contractors = ::testing::Types<
    GlobalClusteringContractionNoMigration, GlobalClusteringContractionMinimalMigration,
