...
TEST(MathTest, encode_virtual_square_5elements) {
    ...
    EXPECT_EQ(encode_virtual_square_position(1, 0, num_elements), 2);
    EXPECT_EQ(encode_virtual_square_position(1, 1, num_elements), 3);
    EXPECT_EQ(encode_virtual_square_position(2, 0, num_elements), 4);
}
...
TEST(MathTest, decode_virtual_square_5elements) {
    ...
    EXPECT_EQ(decode_virtual_square_position(2, num_elements), std::make_pair(1, 0));
    EXPECT_EQ(decode_virtual_square_position(3, num_elements), std::make_pair(1, 1));
    EXPECT_EQ(decode_virtual_square_position(4, num_elements), std::make_pair(2, 0));
}
...
TEST(MathTest, encode_virtual_square_8elements) {
    ...
    EXPECT_EQ(encode_virtual_square_position(1, 1, num_elements), 3);
    EXPECT_EQ(encode_virtual_square_position(2, 0, num_elements), 4);
    EXPECT_EQ(encode_virtual_square_position(2, 1, num_elements), 5);
    EXPECT_EQ(encode_virtual_square_position(3, 0, num_elements), 6);
    EXPECT_EQ(encode_virtual_square_position(3, 1, num_elements), 7);
}
...
TEST(MathTest, decode_virtual_square_8elements) {
    ...
    EXPECT_EQ(decode_virtual_square_position(3, num_elements), std::make_pair(1, 1));
    EXPECT_EQ(decode_virtual_square_position(4, num_elements), std::make_pair(2, 0));
    EXPECT_EQ(decode_virtual_square_position(5, num_elements), std::make_pair(2, 1));
    EXPECT_EQ(decode_virtual_square_position(6, num_elements), std::make_pair(3, 0));
    EXPECT_EQ(decode_virtual_square_position(7, num_elements), std::make_pair(3, 1));
}
