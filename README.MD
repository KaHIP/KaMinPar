...
```shell
# For AMD64
wget https://github.com/KaHIP/KaMinPar/releases/download/v3.7.3/kaminpar_3.7.3-1_amd64.deb
sudo apt install ./kaminpar_3.7.3-1_amd64.deb

# For ARM64
wget https://github.com/KaHIP/KaMinPar/releases/download/v3.7.3/kaminpar_3.7.3-1_arm64.deb
sudo apt install ./kaminpar_3.7.3-1_arm64.deb
```
...
```shell
# For AMD64
sudo dnf install https://github.com/KaHIP/KaMinPar/releases/download/v3.7.3/kaminpar-3.7.3-1.x86_64.rpm

# For ARM64
sudo dnf install https://github.com/KaHIP/KaMinPar/releases/download/v3.7.3/kaminpar-3.7.3-1.aarch64.rpm
```
