...
> [!TIP]
> If you want to partition a graph that does not fit into memory, you can use our (Builder interface)[docs/graph_compression.md] to construct a graph and compress it on-the-fly.
