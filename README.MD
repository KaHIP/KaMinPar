...
> [!NOTE]
> Use `--preset=distributed` instead if you want to use the distributed-memory components.
...
Alternatively, you can specify the maximum weight for each block explicitly through one of the following options:
