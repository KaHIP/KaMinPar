...
PYBIND11_MODULE(pykaminpar, m) {
    m.doc() = "KaMinPar: (Somewhat) Minimal Shared-Memory Graph Partitioning for Large k";
    m.def(
        "partition_file",
        [](const std::string& filename, const BlockID k, const std::string& preset = "default",
           const int num_threads = 0, const double epsilon = 0.03, const int seed = 0, const bool quiet = false) {
        ...
        "A function that partitions a graph in a METIS file", pybind11::arg("filename"), pybind11::arg("k"),
        pybind11::arg("preset") = "default", pybind11::arg("num_threads") = 0, pybind11::arg("epsilon") = 0.03,
        pybind11::arg("seed") = 0, pybind11::arg("quiet") = true
    );
    m.def(
        "partition",
        [](const pybind11::object& xadj, const pybind11::object& adjncy, const pybind11::object& vwgt,
           const pybind11::object& adjwgt, const BlockID k, const std::string& preset = "default",
           const int num_threads = 0, const double epsilon = 0.03, const int seed = 0, const bool quiet = false) {
            ...
            auto builder =
                libkaminpar::PartitionerBuilder::from_adjacency_array(xadjv.size() - 1, xadjv.data(), adjncyv.data());
            if (!vwgtv.empty()) {
        ...
        "A function that partitions a graph held in memory", pybind11::arg("xadj"), pybind11::arg("adjncy"),
        pybind11::arg("vwgt"), pybind11::arg("adjwgt"), pybind11::arg("k"), pybind11::arg("preset") = "default",
        pybind11::arg("num_threads") = 0, pybind11::arg("epsilon") = 0.03, pybind11::arg("seed") = 0,
