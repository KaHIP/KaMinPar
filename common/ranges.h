...
public:
    ...
    public:
        ...
        explicit iterator(const Int value, const Function transformer) : _value(value), _transformer(transformer) {}
...
public:
    ...
    public:
        ...
        explicit iterator(Iterator iter, Function transformer) : _iter(iter), _transformer(transformer) {}
