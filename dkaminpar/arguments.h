...
CLI::Option_group *create_colored_lp_refinement_options(CLI::App *app,
                                                        Context &ctx);
...
CLI::Option_group *create_local_lp_coarsening_options(CLI::App *app,
                                                      Context &ctx);
CLI::Option_group *create_global_lp_coarsening_options(CLI::App *app,
                                                       Context &ctx);
