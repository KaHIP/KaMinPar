...
Context create_default_context() {
  return {.rearrange_by = GraphOrdering::DEGREE_BUCKETS,
          ...
          .refinement =
              {
                  .algorithms = {KWayRefinementAlgorithm::GREEDY_BALANCER,
...
Context create_tr_fast_context() { return create_default_context(); }

Context create_tr_strong_context() { return create_strong_context(); }
} // namespace kaminpar::dist
