...
#pragma omp parallel
    ...
    //
    localize_global_edge_list(local_edges, graph.offset_n(), cluster_mapping);

    START_TIMER("Bucket sort nodes by cluster");
    auto  bucket_sort_result      = build_node_buckets(graph, cluster_mapping, c_n, local_edges, clustering);
